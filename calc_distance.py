...
logging.info("variable set: "+variable)
logging.info("input data path: "+distancd_h5_path)
...
train_sig, train_bkg, train_x, train_sig_wgts, train_bkg_wgts, train_truth_sig_labels, train_truth_bkg_labels = adj.data_loader(distance_h5_path, "", "train", kinematics, signal=signal)
val_sig, val_bkg, val_x, val_sig_wgts, val_bkg_wgts, val_truth_sig_labels, val_truth_bkg_labels = adj.data_loader(distance_h5_path, "", "val", kinematics, signal=signal)
test_sig, test_bkg, test_x, test_sig_wgts, test_bkg_wgts, test_truth_sig_labels, test_truth_bkg_labels = adj.data_loader(distance_h5_path, "", "test", kinematics, signal=signal)
