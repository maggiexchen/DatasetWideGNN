...
echo "python torch_train.py --MLconfig config/ml_LQ_ef0p1.yaml --user config/user_Holly_ARC.yaml"
python torch_train.py --MLconfig config/ml_LQ_ef0p1.yaml --user config/user_Holly_ARC.yaml 
