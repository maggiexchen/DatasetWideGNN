...
def data_loader(h5_path, kinematics, ex="", signal="LQ", signal_mass="",
    ...
    if num_folds is not None:
        ...
        # sig_folds = df_sig[fold_var].apply(lambda x: misc.assign_fold_randomly(n_folds=num_folds))
        # bkg_folds = df_bkg[fold_var].apply(lambda x: misc.assign_fold_randomly(n_folds=num_folds))
